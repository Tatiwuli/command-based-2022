...
public class AutoDriveShootAndGrabOneCommand extends SequentialCommandGroup {
    ...
    public AutoDriveShootAndGrabOneCommand(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, ElevatorSubsystem elevatorSubsystem, IntakeSubsystem intakeSubsystem) {
